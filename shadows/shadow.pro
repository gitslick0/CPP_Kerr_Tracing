...
ly=401 
 ...
 ;Openr,lunAo10x,'shadowx.txt',/Get_Lun
 ; Point_lun,lunAo10x,0
  ;diskx=fltarr(lx,ly)
  ;ReadF,lunAo10x,diskx
  
 ;Openr,lunAo10y,'shadowy.txt',/Get_Lun
 ; Point_lun,lunAo10y,0
  ;disky=fltarr(lx,ly)
  ;ReadF,lunAo10y,disky
...
;print,LLevell
 ;======================================================
  ...
  ratio=1;3.529
   ...
   device,filename='weaklens1_16.ps',xsize=xxss,ysize=yyss,bits_per_pixel=8,/color,xoff=(21.5-xxss)/2.0,yoff=(21.5-yyss)/2.,$
