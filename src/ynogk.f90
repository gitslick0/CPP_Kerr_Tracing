...
!**********************************************************************************
      module constants_return
!*************************************************************************
!* This module returns some of the constants defined above via a return function
!* This is mainly used to test linking of this file in wrappers
!**********************************************************************************
        use constants
        implicit none
      contains
        function fortran_return_pi() result(value)
            implicit none
            real :: value
            value = pi
        end function fortran_return_pi
!**********************************************************************
      end module constants_return
!************************************************************************
